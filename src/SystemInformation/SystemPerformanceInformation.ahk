...
SystemPerformanceInformation()
{
	...
	if (DllCall("ntdll\NtQuerySystemInformation", "Int", SYSTEM_PERFORMANCE_INFORMATION, "Ptr", 0, "UInt", 0, "UInt*", &Size := 0) != STATUS_SUCCESS)
	{
		Buf := Buffer(Size, 0)
		if (DllCall("ntdll\NtQuerySystemInformation", "Int", SYSTEM_PERFORMANCE_INFORMATION, "Ptr", Buf.Ptr, "UInt", Buf.Size, "UInt*", 0) = STATUS_SUCCESS)
		{
