...
SystemPerformanceInformation()
{
	...
	static SYSTEM_PERFORMANCE_INFORMATION := 0x02

	Buf := Buffer(0, 0)
	DllCall("ntdll\NtQuerySystemInformation", "Int", SYSTEM_PERFORMANCE_INFORMATION, "Ptr", Buf.Ptr, "UInt", 0, "UInt*", &Size := 0)
	Buf := Buffer(Size, 0)
	if !(DllCall("ntdll\NtQuerySystemInformation", "Int", SYSTEM_PERFORMANCE_INFORMATION, "Ptr", Buf.Ptr, "UInt", Buf.Size, "UInt*", 0))
	{
